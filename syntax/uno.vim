...
call IncludeFileTypeAsGroup('cpp', 'InlineCPlusPlus')

syntax region ForeignCPlusPlus matchgroup=Special start="@{" end="@}" contains=@InlineCPlusPlus keepend
